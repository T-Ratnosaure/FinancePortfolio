...
def main() -> None:
    ...
    try:
        fetcher = FREDFetcher()
        print("✓ FRED fetcher initialized successfully")
    except Exception as e:
        print(f"✗ Failed to initialize FRED fetcher: {e}")
    ...
    if fetcher.validate_connection():
        print("✓ Connection to FRED validated")
    else:
    ...
    try:
        ...
        print(f"   ✓ Retrieved {len(vix_df)} VIX observations")
    ...
    try:
        ...
        print(f"   ✓ Retrieved {len(treasury_df)} Treasury observations")
    ...
    try:
        ...
        print(f"   ✓ Retrieved {len(spreads_df)} spread observations")
    ...
    try:
        ...
        print(f"   ✓ Retrieved {len(indicators)} indicator observations")
